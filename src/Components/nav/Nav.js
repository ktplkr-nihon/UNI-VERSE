...
{ 
 ...
 render()
  ...
  <button className="dropbtn">EXPLORE{this.props.navroute === 'planets'||this.props.navroute === 'galaxies'||this.props.navroute === 'blackhole' ? <div className='navlocator'></div> : <div></div> }</button>
